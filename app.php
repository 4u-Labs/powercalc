        ...
        <div class="modal-card">
            ...
            <div class="modal-pane active" id="panelModalConfig">
                ...
                <div style="margin-bottom: 10px; text-align: left;">
                    <label class="panel-label" id="lblConfigLanguage" style="display: block; margin-bottom: 4px;">Idioma / Language</label>
                    <select class="panel-select" id="selectLanguage" style="width: 100%; font-weight: 600; padding: 4px 8px; font-size: 11px;">
